...
python examples/run_hdmi.py viewer="mujoco-rerun" rerun_spawn=true horizon=0.8 knot_dt=0.2 ctrl_dt=0.04 num_samples=512  temperature=0.1 max_num_iterations=32 joint_noise_scale=0.2 first_ctrl_noise_scale=1.0 improvement_check_steps=1 improvement_threshold=0.02 #ctrl_dt=0.02 knot_dt=0.02 horizon=0.02 joint_noise_scale=0.0001 max_num_iterations=1
